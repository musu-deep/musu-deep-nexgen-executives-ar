...
const PATH_MODULES = [
  ...
  [/^\/tasks(?:\/.*)?$/, "tasks"],
  [/^\/meetings(?:\/.*)?$/, "meetings"],
  [/^\/meeting-requests(?:\/.*)?$/, "meeting_requests"],
  [/^\/calendar(?:\/.*)?$/, "calendar"],
  [/^\/messages(?:\/.*)?$/, "messages"],
  ...
  [/^\/hr(?:\/.*)?$/, "human_resources"],
  [/^\/team(?:\/.*)?$/, "team"],
  [/^\/executive-secretariat(?:\/.*)?$/, "executive_secretariat"],
  [/^\/legal-affairs(?:\/.*)?$/, "legal_affairs"],
  [/^\/quality-control(?:\/.*)?$/, "quality_control"],
  [/^\/documents(?:\/.*)?$/, "documents"],
  [/^\/daily-report(?:\/.*)?$/, "daily_report"],
  [/^\/camera-monitoring(?:\/.*)?$/, "camera_monitoring"],
  [/^\/presidential-advisor(?:\/.*)?$/, "presidential_advisor"],
  [/^\/voice(?:\/.*)?$/, "voice"],
  [/^\/ai-lounge(?:\/.*)?$/, "ai_lounge"],
  [/^\/odoo-integration(?:\/.*)?$/, "odoo_integration"],
  [/^\/reports(?:\/.*)?$/, "reports"],
  [/^\/admin(?:\/.*)?$/, "admin"],
];
...
function profileText(user) {
  return [user?.email, user?.title, user?.department, user?.name]
    .filter(Boolean)
    .join(" ")
    .toLowerCase();
}
...
export function allowedModulesForUser(user) {
  ...
  (AREA_MODULES[area] || []).forEach((module) => allowed.add(module));
  return allowed;
}
...
export function moduleForPath(pathname) {
  const match = PATH_MODULES.find(([pattern]) => pattern.test(pathname || "/"));
...
export const FUNCTIONAL_AREA_LABELS = {
  full: "الإدارة الكاملة",
  human_resources: "الموارد البشرية",
  secretariat: "السكرتارية والمتابعة التنفيذية",
  legal: "الشؤون القانونية",
  quality: "التفتيش والرقابة والجودة",
  development: "التنمية والتطوير",
  investment: "الاستثمار",
  operations: "العمليات والتنفيذ",
  digital: "التحول الرقمي",
  general: "المهام الوظيفية المسندة",
};
