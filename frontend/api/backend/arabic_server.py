...
AGENT_TRANSLATIONS = {
    "CEO Office": ("مكتب الرئيس التنفيذي", "يتابع الأولويات والقرارات والتصعيدات التنفيذية ويقترح الإجراء الأفضل التالي."),
...
async def daily_executive_report_ar(user=Depends(get_current_user)):
    ...
    report["ai_summary"] = gemini_summary or (
        f"موجز مكتب الرئيس التنفيذي: يوجد {metrics.get('critical_projects', 0)} مشروع حرج، "
